# app/controllers/admin/advertisers_controller.rb
...
class Admin::AdvertisersController < ApplicationController
  ...
  def create
    ...
    if @advertiser.save
      redirect_to admin_advertisers_path, notice: 'Advertiser successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @advertiser.update(advertiser_params)
      redirect_to admin_advertisers_path, notice: 'Advertiser successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @advertiser.destroy
    redirect_to admin_advertisers_path, notice: 'Advertiser successfully deleted.'
  end
